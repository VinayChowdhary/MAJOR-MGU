			...
			<div id="logo">
				<div id="logo_text">
					<br /> <br /> <font size="5"><a href="index.html"><span
							class="logo_colour">A Practical Attribute-Based Document Collection Hierarchical Encryption Scheme in Cloud Computing</span></a></font>
				</div>
			</div>
			<div id="menubar">
				<ul id="menu">
		...
		<div id="site_content">
			...
			<div id="content">
				...
				<%
					...
					if (filename != null) {
						conn.createStatement().executeUpdate("delete from userfiles where filename='" + filename + "'");

						conn.createStatement().executeUpdate("delete from files where name='" + filename + "'");
